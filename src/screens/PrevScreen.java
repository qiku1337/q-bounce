...
public class PrevScreen implements GameScreen {
    ...
    @Override
	public void prepare() {
		Game.assets.load("assets/load.png", Texture.class);              
	}
    ...
    public void render(float delta) {
        ...
        spriteBatch.draw(currentFrame, 150, 150,                        //miejsce rysowania
                Gdx.graphics.getWidth()/8.f,Gdx.graphics.getHeight()/5.f);  //wielkosc  
